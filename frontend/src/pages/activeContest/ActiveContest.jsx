...
function ActiveContest({ user, token, setPageType }) {
    ...
    React.useEffect(() => {
        var url = `${process.env.REACT_APP_URL_LINK}/api/quiz/active-contest?page=${pageNumber}`;
      	...
      	<MainLayout>
            <div className="resultsContainer">
                <div className="resultsContainer__header">
                        <h2 className="resultsContainer__title">{t("active__contest__header")}</h2>
                </div>
                {
                    !fData && <Loader />
                }
...
export default connect(mapStateToProps, mapDispatchToProps)(ActiveContest);
